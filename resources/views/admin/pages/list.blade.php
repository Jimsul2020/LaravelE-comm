			...
			<form method="get" action="">
				<div class="card-header">
					<div class="card-title">
						<button onclick="window.load.href="{{route('pages.index')}}" class="btn btn-default btn-sm">Reset</button>
					</div>
				...
				<table class="table table-hover text-nowrap">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{route('edit.pages', $page->id)}}">
...
<script>
	function deletePage(id) {
		var url = '{{route("destroy.pages", "ID")}}';
