...
@section('content')
     ...
     <form action="" method="post" name="discountForm" id="discountForm">
           ...
           <input type="number" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="max uses users" value="{{$coupon->max_uses_user}}">
           <p></p>	
										</div>
									</div>
									<div class="col-md-6">
           ...
           <input type="number" name="min_amount" id="min_amount" class="form-control" placeholder="Minimum Amount" value="{{$coupon->min_amount}}">
           <p></p>	
										</div>
									</div>
									<div class="col-md-6">
           ...
           <input autocomplete="off" type="text" name="start_at" id="start_at" class="form-control" placeholder="Start At" value="{{$coupon->start_at}}">
           <p></p>	
										</div>
									</div>		
									<div class="col-md-6">
           ...
           <input autocomplete="off" type="text" name="expires_at" id="expires_at" class="form-control" placeholder="Expire At" value="{{$coupon->expires_at}}">
           <p></p>	
										</div>
									</div>	
									<div class="col-md-6">
										<div class="mb-3">
											...
											<textarea type="text" name="description" id="description" cols="30" rows="3" class="form-control" placeholder="Description">	{{$coupon->description}}
           </textarea>
           <p></p>
										</div>
									</div>						
 ...
 $(document).ready(function(){
  $("#discountForm").submit(function(event){
   ...
   var formData = $(this).serialize();
			...
			$.ajax({
				url: '{{route("update.coupon", $coupon->id)}}',
				type: 'put',
				data: formData,
				dataType: 'json',
