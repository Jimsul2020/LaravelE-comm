        ...
        <div class="container  mt-5">
            <div class="row">
                ...
                <div class="card">
                        ...
                        <form action="" method="post" id="updateForm" name="updateForm"></form>
                            <div class="row">
                                <div class="mb-3">               
            ...
            success: function(response){
                if (response == true){
                    ...
                    if(errors.old_password){
                        ...
                        $('#old_password').removeClass('is-invalid').siblings('p').html(errors.old_password);
                    }

                    if(errors.new_password){
                        $("#new_password").addClass('is-invalid').siblings('p').html(errors.new_password).addClass('invalid-feedback');
                    }else{
                        $('#new_password').removeClass('is-invalid').siblings('p').html(errors.new_password);
                    }
