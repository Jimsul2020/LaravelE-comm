    ...
    <section class="section-4 pt-5">
        <div class="container">
            ...
            <div class="row pb-3">
                ...
                @foreach($featuredProduct as $featProd)
                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="{{route('front.product', $featProd->slug)}}" class="product-img">
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                ...
                @foreach($latestProducts as $latestProd)
                    @php
						$productImage = $latestProd->product_images->first();
					@endphp
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="{{route('front.product', $latestProd->slug)}}" class="product-img">
                                {{-- <img class="card-img-top" src="{{asset('front-assets/images/product-1.jpg')}}" alt=""> --}}
                        ...
                        <div class="card-body text-center mt-3">
                            <a class="h6 link" href="product.php">{{$latestProd->title}}</a>
                            <div class="price mt-2">
                                <span class="h5"><strong>&#8358;{{$latestProd->price}}</strong></span>
                                @if($latestProd->compare_price > 0)
                                <span class="h6 text-underline"><del>&#8358;{{$latestProd->compare_price}}</del></span>
                                @endif
                            </div>
                        </div>                        
                    </div>                                               
