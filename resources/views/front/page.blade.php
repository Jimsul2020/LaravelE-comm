                ...
                <div class="col-md-6">
                    <form class="shake" role="form" method="post" id="contactForm" name="contactForm">
                        ...
                        <div class="form-submit">
                            <button class="btn btn-dark" type="submit" id="formSubmit" name="formSubmit"><i class="material-icons mdi mdi-message-outline"></i> Send Message</button>
                ...
                if(response.status == true){
                    window.location.href = "{{route('font.page', $page->slug)}}";
						...
						$("#email").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback')
							.html("");
						$("#subject").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback')
							.html("");
						$("#message").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback')
							.html("");
                }else{
                    ...
                    if (errors['name']) {
                        ...
                        if (errors['subject']) {
							$("#subject").addClass('is-invalid').siblings('p').addClass('invalid-feedback')
								.html(errors['subject']);
						} else {
							$("#subject").removeClass('is-invalid').siblings('p').removeClass('invalid-feedback').html("");
						}
                        if (errors['message']) {
							$("#message").addClass('is-invalid').siblings('p').addClass('invalid-feedback')
								.html(errors['message']);
						} else {
