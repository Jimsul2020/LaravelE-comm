...
<body style="font-family: Arial, Helvetica, sans-serif; font-size:16px;">
    ...
    <address>
        ...
        {{$mailData['order']->city}}, {{$mailData['order']->zip}} {{getStateInfo($mailData['order']->state_id)->name}}, {{getLgaInfo($mailData['order']->lga_id)->lga}}<br>
    ...
    <table class="" cellpadding="3" cellspacing="3" border="0">
        <thead>
